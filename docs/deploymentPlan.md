...
sequenceDiagram
    ...
    FE->>BE: POST https://zomato-backend.up.railway.app/api/v1/recommendations
...
3. **Configure Environment Variables:**
   ...
   - `GROQ_API_KEY`, `LLM_MODEL`, `CORS_ORIGINS` as described in Option A.
...
1. Access the backend health endpoint in your browser:
   `https://your-backend-app.up.railway.app/api/v1/health`
