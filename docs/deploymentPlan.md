...
sequenceDiagram
    ...
    FE->>BE: POST https://zomato.recomend.railway.com/api/v1/recommendations
...
3. **Configure Environment Variables:**
   ...
   - `VITE_API_BASE_URL`: `https://zomato.recomend.railway.com`
...
1. Access the backend health endpoint in your browser:
   `https://zomato.recomend.railway.com/api/v1/health`
